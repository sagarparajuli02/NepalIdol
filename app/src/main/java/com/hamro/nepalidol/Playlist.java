...
import com.hamro.nepalidol.youtube.JsonParser;
import com.hamro.nepalidol.youtube.Video;
import com.hamro.nepalidol.youtube.VideoAdapter;
...
public class Playlist extends AppCompatActivity implements AdapterView.OnClickListener, AdapterView.OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?>parent , View view, int position, long id) {
        ...
        intent.setData(Uri.parse("http://m.youtube.com/watch?v="+video));
