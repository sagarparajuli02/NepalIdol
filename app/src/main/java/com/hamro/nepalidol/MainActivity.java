...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id==R.id.update){
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=in.technicalguruji"));
            startActivity(intent);
        }
        if (id==R.id.exit){
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        else  if(id==R.id.disclaminar){
            Intent intent= new Intent(MainActivity.this,Disclaminar.class);
            startActivity(intent);
        }
